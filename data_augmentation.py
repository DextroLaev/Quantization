...
"""
Data augmentation classes for image transformations.
Includes Cutout, AutoAugment policies for ImageNet and CIFAR10.
"""
...
class SubPolicy(object):
    """SubPolicy for AutoAugment combining two operations."""
    ...
    def gen(self, operation1, magnitude_idx1, operation2, magnitude_idx2, fillcolor):
        """Generate operation functions and magnitudes."""
        ranges = {
